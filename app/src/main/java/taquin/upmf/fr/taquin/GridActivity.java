...
public class GridActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            if(  value.equals("deb") ){
                tt = new Image2Adapter(this , 3 , 3 ) ; // Pour créer un Jeu en 3x3
                gridview.setColumnWidth(metrics.widthPixels / 3 );
            }

            if ( value.equals("inter") ){
                tt = new Image2Adapter(this , 4 , 4 ) ; // Pour créer un Jeu en 4x4
                gridview.setColumnWidth(metrics.widthPixels / 4 );
            }
            if ( value.equals("exp") ){
                tt = new Image2Adapter(this , 5 , 5 ) ; // Pour créer un Jeu en 5x5
