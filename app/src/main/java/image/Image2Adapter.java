...
public class Image2Adapter extends BaseAdapter {
    ...
    private Context mContext; // Qu'est ce que c'est ?
    private Bitmap img ;
    ...
    public Image2Adapter(Context c , int w , int h ){ // Met en place la jeu en fonction de la hauteur et de la largeur donnée

        mContext = c;
        img = BitmapFactory.decodeResource(c.getResources(), R.drawable.pp); //Creates Bitmap objects + Decode a new Bitmap
